...
API Endpoints (Core)MethodEndpointDescriptionGET/api/v1/projectsFetch paginated list of enterprise projectsGET/api/v1/projects/{id}Retrieve detailed project status by IDPOST/api/v1/projectsCreate a new project recordPUT/api/v1/projects/{id}Update existing project attributesDELETE/api/v1/projects/{id}Remove project record
...
git add README.md
git commit -m "docs: format README structure and layout"
